...
namespace ArcherLoader.Editor
{
    ...
    public class OverlayTextButton : EditorUI
    {
        ...
        public OverlayTextButton(Vector2 position, string text, Action<OverlayTextButton> onClick,
            Func<bool> activeCheck, int width = 120, int height = 30)
        ...
        public override void Render()
        {
            ...
            Draw.TextCentered(TFGame.Font, text, Position, color, Vector2.One * (3f + 0.5f * scaleWiggler.Value),
                MathF.PI / 30f * rotateWiggler.Value);
        }
